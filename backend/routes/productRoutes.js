...
const { getAllProducts, getProductById, createNewProduct, getProductsByCategory, editAllProduct, deleteAllProduct, addProductMaterial } = require("../controllers/productController");
